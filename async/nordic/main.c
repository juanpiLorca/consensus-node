...
// `update_consensus` is assumed to be defined externally.
...
K_THREAD_DEFINE(thread_consensus_id, APP_STACK_SIZE, thread_slow_network, 
...
 */
static void thread_slow_network(void) {
