...
NODES = {
  1: {ip: '192.168.0.136', type: TYPE_BLE,    enabled: true, neighbors: [4], clock: 1000, state: 2000,  vstate: 500,  vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  2: {ip: '192.168.0.136', type: TYPE_WIFI,   enabled: true, neighbors: [5], clock: 1000, state: 5000,  vstate: 3500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  3: {ip: '192.168.0.136', type: TYPE_BRIDGE, enabled: true, neighbors: [8], clock: 1000, state: 8000,  vstate: 6500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  4: {ip: '192.168.0.101', type: TYPE_BLE,    enabled: true, neighbors: [7], clock: 1000, state: 3000,  vstate: 1500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  5: {ip: '192.168.0.101', type: TYPE_WIFI,   enabled: true, neighbors: [9], clock: 1000, state: 4000,  vstate: 2500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  6: {ip: '192.168.0.101', type: TYPE_BRIDGE, enabled: true, neighbors: [2], clock: 1000, state: 9000,  vstate: 7500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  7: {ip: '192.168.0.134', type: TYPE_BLE,    enabled: true, neighbors: [3], clock: 1000, state: 2000,  vstate: 4500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  8: {ip: '192.168.0.134', type: TYPE_WIFI,   enabled: true, neighbors: [6], clock: 1000, state: 7000,  vstate: 5500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
  9: {ip: '192.168.0.134', type: TYPE_BRIDGE, enabled: true, neighbors: [1], clock: 1000, state: 10000, vstate: 8500, vartheta: 0, eta: 5000, disturbance: {amplitude: 500, offset: 500, samples: 1}, laplacian: 1},
}; 
